...
import com.epita.creeps.given.vo.report.MineReport;
 ...
 * On 2019-04-20 01:23
 */
public class CallableMineReport implements Callable
{
    Unit unit;
    String reportId;

    public CallableMineReport(Unit unit, String reportId) {
        this.unit = unit;
    ...
    public Report call() throws Exception
    {
          Report res = GenericRequest.genericGet(this.unit.getGame().getUrl()
                + "/report/" + this.reportId, MineReport.class);
        return res;
    }
}
